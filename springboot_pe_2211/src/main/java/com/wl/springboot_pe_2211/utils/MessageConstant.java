...
public class MessageConstant {
    ...
    public static final String UPDATE_CHECKGROUP_PARAM_ERROR = "修改检查组参数异常";



    public static final String DELETE_NOT_SET_MEAL_01 = "套餐中包含了检查组，禁止删除";
    public static final String DELETE_NOT_SET_MEAL_02 = "套餐中包含了订单，禁止删除";
    public static final String DELETE_SET_MEAL_ERROR = "删除套餐信息失败";
    public static final String DELETE_SET_MEAL_SUCCESS = "删除套餐信息成功";
    public static final String ADD_OR_UPDATE_SETMEAL_SUCCESS = "添加或者更新套餐成功";
}
